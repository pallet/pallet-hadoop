...
(defn test-cluster [ip-type nodecount]
...
(defn test-kill []
  (kill-cluster (test-cluster :private 0) :compute env/ec2-service :environment env/remote-env))
